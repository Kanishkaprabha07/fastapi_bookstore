...
@app.post("/signup", response_model=UserResponse,tags =["Register"])
...
@app.post("/auth/refresh",tags =["Tokens"])
...
@app.get("/books/all",response_model=List[BookSchema],tags =["Books"])
...
@app.get("/users/all",response_model=List[UserResponse],tags =["User"])
...
@app.get("/authors", response_model=List[AuthorSchema],tags =["Author"])
...
@app.post("/books/{book_id}/author", response_model=AuthorSchema,tags =["Author"])
...
@app.put("/authors/{author_id}", response_model=AuthorSchema,tags =["Author"])
...
@app.put("/users/{user_id}", response_model= UserResponse,tags =["User"])
...
@app.delete("/authors/{author_id}",tags =["Author"])
